			...
			for(i=0;i<filelist.length;i++){
				...
				xhr1.onreadystatechange=function(){
					if(xhr1.readyState==4 && xhr1.status==200){
						...
						row.innerHTML="<td><button class='btn btn-default'><em class='fa fa-pencil'></em></button><button class='btn btn-danger'><em class='fa fa-trash'></em></button></td><td>"+xhr1.getResponseHeader("Last-Modified")+"</td><td><a href='"+"data/"+path+"/"+sessionStorage["filepath"]+"' download>"+sessionStorage["filepath"]+"</a></td>";
